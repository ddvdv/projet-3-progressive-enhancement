...
<html lang="fr">
   <head>
      ...
      <title>De l'importance des choses</title>
   </head>
   ...
   <body>
      ...
      <blockquote>Dans la nature, <em class="bien">Bien</em> & <em class="mal">Mal</em> n’existent pas. L'Univers lui-même n'est ni bon ni mauvais, mais un potentiel en développement permanent.</blockquote>
      </header>
      ...
      <figure>
         <img src='https://cdn-images-1.medium.com/max/1000/1*2PCmLZyzQaF2pyKYkSTFpA.jpeg' alt="photo d'un garnement vidant un extincteur"/>
      </figure>
      ...
      <figure>
         <img src='http://static2.businessinsider.com/image/52fe8230eab8ea4275063b89/nasa-has-determined-where-the-mysterious-jelly-doughnut-rock-on-mars-came-from.jpg' alt="photo d'un rocher sur Mars qui n'en a rien à caler"/>
      </figure>

      <p>Le rocher sur Mars ne fait pas la différence entre <em class="bien">Bien</em> et <em class="mal">Mal</em>, car pour lui, ni l’un ni l’autre n’existent.</p>
      ...
      <p>C’est l’histoire d’un fermier qui possède un cheval. Un jour, le cheval s’enfuit. Les villageois s’ameutent à la maison du fermier pour lui remonter le moral. <q class="villageois">Quelle <em class="mal">Mal</em>chance ! Ton seul cheval ! Nous sommes vraiment désolé pour cette perte, c’est si triste !</q></p>

      <p>Le fermier répond, <q class="fermier">Est-ce un <em class="bien">Bien</em>? Est-ce un <em class="mal">Mal</em>? Je ne sais pas.</q></p>

      <p>Le jour suivant, le cheval revient avec sept magnifiques juments. Les villageois reviennent pour célébrer la bonne nouvelle. <q class="villageois">Quelle chance incroyable ! Avec huit chevaux, tu es un homme riche ! Tu dois être ravis de cette nouvelle !</q></p>

      <p>Le fermier répond, <q class="fermier">Est-ce un <em class="bien">Bien</em>? Est-ce un <em class="mal">Mal</em>? Je ne sais pas.</q></p>

      <p>Le jour d’après, le fils du fermier s’occupe de l’entraînement des nouveaux chevaux. Mais l’un d’entre eux s’est révélé agressif; le garçon tombe et se casse la jambe. Les villageois reviennent. <q class="villageois">Pauvre enfant ! Nous sommes si désolé pour ce qui est arrivé ! Nous espérons qu’il s’en remettra <em class="bien">Bien</em>tôt, c’est tellement dommage…</q></p>

      <p>Le fermier répond, <q class="fermier">Est-ce un <em class="bien">Bien</em>? Est-ce un <em class="mal">Mal</em>? Je ne sais pas.</q></p>

      <p>Le quatrième jour, l’armée arrive au village à la recherche de nouvelles jeunes recrues. Grâce à sa jambe cassée, le fils du fermier échappe au recrutement. <q class="villageois">Quelle nouvelle incroyable ! Ton fils échappera à cette guerre sanglante, il vivra, à tes côtés ! Tu dois être tellement heureux, c’est fantastique !</q></p>
      ...
      <p>
      Vous trouverez ici <a target="_blank" title="La lib'" href="http://www.lalibre.be">un contre-exemple</a> accordant une illusion d'importance à un peu tout et n'importe quoi...<br>
      Un exemple encore plus extrême pour être trouvé sur <a target="_blank" title="le market" href="https://www.amazon.com/">le lien suivant</a>
      </p>
      ...
      <p>Le <em class="bien">Bien</em> et le <em class="mal">Mal</em> sont des valeurs culturelles et non naturelles. La banane est bonne pour le singe, le singe n'est pas bon pour la banane. N'en faisons donc pas un fromage...</p>
       ...
       <footer>  
      <hr>----
      Copyright Just Another Company 2017. Tous droits réservés. Très largement adapté de cet article: https://medium.com/scribe/il-ny-a-rien-de-<em class="bien">Bien</em>-ni-de-<em class="mal">Mal</em>-3d46a2d2e263
      </footer>
